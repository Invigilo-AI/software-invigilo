...
export async function registerGlobalComponents({ app }: VueroAppContext) {
  ...
  app.component(
    ...
    defineAsyncComponent({
      loader: () => import('v3-num').then((mod) => mod.default),
      delay: 0,
      suspensible: false,
    })
  )
  ...
  app.component(
    ...
    'ApexChart',
    defineAsyncComponent({
      loader: () => import('vue3-apexcharts').then((mod) => mod.default),
      delay: 0,
      suspensible: false,
    })
  )
  ...
  app.component(
    ...
    'InfiniteLoading',
    defineAsyncComponent({
      loader: () => import('v3-infinite-loading').then((mod) => mod.default),
      delay: 0,
      suspensible: false,
    })
  )
  ...
  router.beforeEach(async (to, from) => {
    ...
    if (from === START_LOCATION && userSession.isLoggedIn) {
      ...
      try {
        ...
        notyf.success(`Welcome back, ${user.full_name}`)
      } catch (err) {
