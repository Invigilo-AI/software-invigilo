# Image manipulation
For Boundaries is used [Konva](https://konvajs.org/docs/vue/index.html)

# Install

Setup environment variables:
- Setup `VITE_API_BASE_URL` for the base path of the API (without `/` at the end)
- Change `VITE_NOTIFICATION_TIME_WINDOW` for time limit of incident action (in seconds)
